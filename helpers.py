...
def test_port():
    try:
        ...
        ssh_command = [
            ...
            'ssh', f'{username}@{host}', # we're assuming here that transmission is running on the same host as your VPN container
            f'echo {str(docker_password)} | sudo -S -p \'\' /usr/local/bin/docker restart your-docker-container-name'
        ]
